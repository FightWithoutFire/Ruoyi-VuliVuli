...
public class ShardingDataSourceConfig
{
    ...
    @Bean
    @ConfigurationProperties("spring.datasource.dynamic.datasource.order1")
    @ConditionalOnProperty(prefix = "spring.datasource.dynamic.datasource.order1", name = "enabled", havingValue = "true")
    ...
    @Bean
    @ConfigurationProperties("spring.datasource.dynamic.datasource.order2")
    @ConditionalOnProperty(prefix = "spring.datasource.dynamic.datasource.order2", name = "enabled", havingValue = "true")
